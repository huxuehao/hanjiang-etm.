...
const handleChange = () => {
  emits("input", config.answer, config.type);
};
</script>
...
<template>
  <div class="box">
    ...
    >
      ...
      <el-form label-position="left" label-width="80px" :model="config">
        <el-row v-if="['correct'].indexOf(mode) === -1">
          <el-form-item
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="最小匹配">
              <el-input :value="config.matchNum" readonly></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
